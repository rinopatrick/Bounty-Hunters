...
// ─── Provider Cache metrics (bounty #865) ───────────────────────────────────
export const providerCacheHitsTotal = Metric.counter(
  "t3_provider_cache_hits_total",
  {
    description: "Total provider model/capability responses served from Effect.Cache.",
  },
);
export const providerCacheMissesTotal = Metric.counter(
  "t3_provider_cache_misses_total",
  {
    description: "Total provider model/capability lookup misses (fresh upstream call).",
  },
);
export const providerCacheLatencyMs = Metric.timer(
  "t3_provider_cache_latency_ms",
  {
    description: "Latency of provider model/capability cache misses (upstream probe duration).",
  },
);
export const providerCacheHealthCheckDurationMs = Metric.timer(
  "t3_provider_cache_healthcheck_duration_ms",
  {
    description: "Duration of GET /health/cache endpoint evaluation.",
  },
);
